...
function onEdit(row: ApiListOutput) {
...
<template>
  <div class="my-layout">
    ...
    <el-card class="my-fill mt8" shadow="never">
      ...
      >
        ...
        <el-table-column label="操作" width="160" fixed="right" header-align="center" align="center">
          <template #default="{ row }">
            <el-button v-auth="'api:admin:api:update'" icon="ele-EditPen" size="small" text type="primary" @click="onEdit(row)">
              编辑
            </el-button>
            <el-button v-auth="'api:admin:api:delete'" icon="ele-Delete" size="small" text type="danger" @click="onDelete(row)">
              删除
            </el-button>
          </template>
        </el-table-column>
    ...
    <ApiForm ref="apiFormRef" :title="state.apiFormTitle" :api-tree-data="state.formApiTreeData" />
  </div>
</template>
