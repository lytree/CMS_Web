...
function formatterTime(cellValue: any) {
  return dayjs(cellValue).format('YYYY-MM-DD HH:mm:ss')
}

function getInitialIndex(imgUrl: string) {
...
<template>
  <div class="my-layout">
    <el-card class="mt8" shadow="never" :body-style="{ paddingBottom: '0' }">
      <el-form :model="state.filterModel" :inline="true" @submit.stop.prevent>
        ...
        <el-form-item>
          ...
          <el-button v-auth="'api:admin:file:upload-file'" type="primary" icon="ele-Upload" @click="onUpload">
            上传
          </el-button>
        </el-form-item>
      </el-form>
        ...
        <el-table-column prop="fileName" label="文件名" min-width="220">
          <template #default="{ row }">
            <div class="my-flex">
              ...
              />
              <div class="my-flex-fill my-flex-y-center ml10">
          ...
          <template #default="{ row }">
            <el-popover :width="220">
              ...
              <div class="mt10" style="text-align: right; margin: 0">
                <el-button icon="ele-CopyDocument" size="small" type="primary" @click="copyText(row.linkUrl)">
                  复制地址
                </el-button>
              </div>
              <template #reference>
            ...
            <el-button v-auth="'api:admin:file:delete'" icon="ele-Delete" size="small" text type="danger" @click="onDelete(row)">
              删除
            </el-button>
          </template>
        </el-table-column>
    ...
    <FileUpload ref="fileUploadRef" title="上传文件" />
  </div>
</template>
