...
function initPieChart() {
  ...
  const getname = ['房屋及结构物', '专用设备', '通用设备', '文物和陈列品', '图书、档案']
  ...
  <div class="home-container layout-pd">
    <el-row :gutter="15" class="home-card-one mb15">
      <el-col v-for="(v, k) in state.homeOne" :key="k" :xs="24" :sm="12" :md="12" :lg="6" :xl="6"
        ...
        <div class="home-card-item flex">
          <div class="flex-margin w100 flex" :class="` home-one-animation${k}`">
            <div class="flex-auto">
            ...
            <div class="home-card-item-icon flex" :style="{ background: `var(${v.color2})` }">
              <i class="flex-margin font32" :class="v.num4" :style="{ color: `var(${v.color3})` }" />
            </div>
          </div>
        </div>
      </el-col>
    ...
    <el-row :gutter="15" class="home-card-two mb15">
      <el-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16">
        <div class="home-card-item">
          <div ref="homeLineRef" style="height: 100%" />
        </div>
      </el-col>
      <el-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8" class="home-media">
        <div class="home-card-item">
          <div ref="homePieRef" style="height: 100%" />
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="15" class="home-card-three">
      <el-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8">
        <div class="home-card-item">
          ...
          <div class="home-monitor">
            <div class="flex-warp">
              <div v-for="(v, k) in state.homeThree" :key="k" class="flex-warp-item">
      ...
      <el-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16" class="home-media">
        <div class="home-card-item">
          <div ref="homeBarRef" style="height: 100%" />
        </div>
      </el-col>
    </el-row>
  </div>
...
.home-container .home-card-one .home-card-item,
.home-container .home-card-two .home-card-item,
.home-container .home-card-three .home-card-item {
  width: 100%;
  height: 130px;
  border-radius: 4px;
...
.home-container .home-card-one .home-card-item:hover,
...
.home-container .home-card-one .home-card-item-icon,
.home-container .home-card-two .home-card-item-icon,
.home-container .home-card-three .home-card-item-icon {
  width: 70px;
  height: 70px;
  border-radius: 100%;
  flex-shrink: 1;
...
.home-container .home-card-one .home-card-item-icon i,
.home-container .home-card-two .home-card-item-icon i,
.home-container .home-card-three .home-card-item-icon i {
  color: var(--el-text-color-placeholder);
}

.home-container .home-card-one .home-card-item-title,
.home-container .home-card-two .home-card-item-title,
.home-container .home-card-three .home-card-item-title {
  font-size: 15px;
  font-weight: bold;
  height: 30px;
}
...
.home-container .home-card-two .home-card-item .home-monitor,
.home-container .home-card-three .home-card-item .home-monitor {
  height: 100%;
}

.home-container .home-card-two .home-card-item .home-monitor .flex-warp-item,
.home-container .home-card-three .home-card-item .home-monitor .flex-warp-item {
  width: 25%;
  height: 111px;
  display: flex;
}

.home-container .home-card-two .home-card-item .home-monitor .flex-warp-item .flex-warp-item-box,
.home-container .home-card-three .home-card-item .home-monitor .flex-warp-item .flex-warp-item-box {
  margin: auto;
  text-align: center;
  color: var(--el-text-color-primary);
  display: flex;
...
.home-container .home-card-two .home-card-item .home-monitor .flex-warp-item .flex-warp-item-box:hover,
.home-container .home-card-three .home-card-item .home-monitor .flex-warp-item .flex-warp-item-box:hover {
