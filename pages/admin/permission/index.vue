...
function onEdit(row: PermissionListOutput) {
  switch (row.type) {
    case 1:
      ...
      <el-form :inline="true" @submit.stop.prevent>
        ...
        <el-form-item>
          ...
          >
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item v-if="auth('api:admin:permission:addgroup')" @click="onAdd(1)">
                  新增分组
                </el-dropdown-item>
                <el-dropdown-item v-if="auth('api:admin:permission:addmenu')" @click="onAdd(2)">
                  新增菜单
                </el-dropdown-item>
                <el-dropdown-item v-if="auth('api:admin:permission:adddot')" @click="onAdd(3)">
                  新增权限点
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
