...
// 设置激活颜色
function onActiveColorPickerChange(name: string) {
...
function onWatermarkTextInput(val: string) {
  ...
  if (getThemeConfig.value.watermarkText === '')
    return false
  if (getThemeConfig.value.isWatermark)
...
<template>
  <div class="layout-breadcrumb-seting">
    <el-drawer
      v-model="getThemeConfig.isDrawer" :title="$t('message.layout.configTitle')" direction="rtl"
      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">
            {{ $t('message.layout.primary') }}
          </div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.primary" :predefine="predefinePrimaryColors" size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.topBar" :predefine="predefineTopBarBgColors" size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.topBarColor" :predefine="predefineFontColors" size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.menuBar" :predefine="predefineMenuBarBgColors" size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.menuBarColor" :predefine="predefineFontColors" size="default"
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.menuBarActiveColor" size="default" show-alpha
              :predefine="predefineActiveBgColors" @change="onBgColorPickerChange('menuBarActiveColor')"
            />
          </div>
        </div>
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.columnsMenuBar" :predefine="predefineColumnsMenuBarBgColors"
              size="default" :disabled="getThemeConfig.layout !== 'columns'"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
              v-model="getThemeConfig.columnsMenuBarColor" :predefine="predefineFontColors" size="default"
              :disabled="getThemeConfig.layout !== 'columns'" @change="onBgColorPickerChange('columnsMenuBarColor')"
            />
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isColumnsMenuBarColorGradual" size="small"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isColumnsMenuHoverPreload" size="small"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isCollapse" :disabled="getThemeConfig.layout === 'transverse'" size="small"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isUniqueOpened" :disabled="getThemeConfig.layout === 'transverse'"
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isClassicSplitMenu" :disabled="getThemeConfig.layout !== 'classic'"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt11">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input-number
              v-model="getThemeConfig.lockScreenTime" controls-position="right" :min="1" :max="9999"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15" :style="{ opacity: state.isMobile ? 0.5 : 1 }">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
              v-model="getThemeConfig.isSortableTagsView" :disabled="state.isMobile ? true : false" size="small"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">
            {{ $t('message.layout.fourIsWatermark') }}
          </div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          <div class="layout-breadcrumb-seting-bar-flex-label">
            {{ $t('message.layout.fourWatermarkText') }}
          </div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input
              v-model="getThemeConfig.watermarkText" size="default" style="width: 90px"
              @input="onWatermarkTextInput"
            />
          </div>
        </div>
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              v-model="getThemeConfig.tagsStyle" placeholder="请选择" size="default" style="width: 90px"
              @change="setLocalThemeConfig"
            >
              <el-option label="卡片" value="tags-style-one" />
              <el-option label="简约" value="tags-style-four" />
              <el-option label="圆滑" value="tags-style-five" />
            </el-select>
          </div>
        </div>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              v-model="getThemeConfig.animation" placeholder="请选择" placement="bottom-end" size="default"
              style="width: 90px" @change="setLocalThemeConfig"
            >
              <el-option label="右滑动" value="slide-right" />
              <el-option label="左滑动" value="slide-left" />
              <el-option label="淡入淡出" value="opacitys" />
            </el-select>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              v-model="getThemeConfig.columnsAsideStyle" placeholder="请选择" size="default" style="width: 90px"
        ...
        <div
          class="layout-breadcrumb-seting-bar-flex mb27 mt15"
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              v-model="getThemeConfig.columnsAsideLayout" placeholder="请选择" size="default" style="width: 90px"
              :disabled="getThemeConfig.layout !== 'columns' ? true : false" @change="setLocalThemeConfig"
            >
        ...
        <div class="layout-drawer-content-flex">
          ...
          <div class="copy-config">
            ...
            <el-button
              ref="copyConfigBtnRef" size="default" class="copy-config-btn" type="primary"
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container {
  height: 100%;
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-aside-dark {
  background-color: var(--next-color-seting-header);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-aside {
  background-color: var(--next-color-seting-aside);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-header {
  background-color: var(--next-color-seting-header);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-container .el-main {
  background-color: var(--next-color-seting-main);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .el-circular {
  border-radius: 2px;
  overflow: hidden;
  border: 1px solid transparent;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp,
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active {
  transition: all 0.3s ease-in-out;
  position: absolute;
  left: 50%;
  top: 50%;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp .layout-tips-box,
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active .layout-tips-box {
  transition: inherit;
  width: 30px;
  height: 30px;
  z-index: 9;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp .layout-tips-box .layout-tips-txt,
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item .layout-tips-warp-active .layout-tips-box .layout-tips-txt {
  transition: inherit;
  position: relative;
  top: 5px;
  font-size: 12px;
...
.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .el-circular {
  transition: all 0.3s ease-in-out;
  border: 1px solid;
  border-color: var(--el-color-primary);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp {
  transition: all 0.3s ease-in-out;
  border-color: var(--el-color-primary);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp .layout-tips-box {
  transition: inherit;
  border-color: var(--el-color-primary);
}

.layout-breadcrumb-seting-bar .layout-drawer-content-flex .layout-drawer-content-item:hover .layout-tips-warp .layout-tips-box .layout-tips-txt {
  transition: inherit;
  color: var(--el-color-primary) !important;
  background-color: var(--next-color-seting-main) !important;
}

.layout-breadcrumb-seting-bar .copy-config {
  margin: 10px 0;
}

.layout-breadcrumb-seting-bar .copy-config .copy-config-btn {
  width: 100%;
  margin-top: 15px;
}

.layout-breadcrumb-seting-bar .copy-config .copy-config-btn-reset {
  width: 100%;
  margin: 10px 0 0;
}
</style>
