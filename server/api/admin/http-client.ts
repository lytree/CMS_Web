...
import { ofetch, fetch, createFetch, $Fetch, FetchResponse, FetchRequest, FetchOptions } from "ofetch";
  ...
  public request = async <T = any>({
    ...
    return this.apiFetch(`${path}`, {
      ...
      onResponse: ({ request, response, options }) => {
        ...
        // Log response
        console.log('[fetch response]', request, response, response._data)
      },
